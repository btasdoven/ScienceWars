...
{
	public class MirrorSoldierIlisionMinionGUI : MinionGUIImp
	{
		...
		public MirrorSoldierIlisionMinionGUI() : base(typeof(MirrorSoldierIlisionMinion))	
		{
		...
		{
			staticMinionObject = (GameObject)Resources.Load("3Ds/Minions/Physics/MirrorSoldierIlisionMinion/MinionObject");
			staticMinionIcon = Resources.Load<Texture2D>("3Ds/Minions/Physics/MirrorSoldierIlisionMinion/GUI/minionIcon");
