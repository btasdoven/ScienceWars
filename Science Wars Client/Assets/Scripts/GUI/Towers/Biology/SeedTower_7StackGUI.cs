...
{
	public class SeedTower_7StackGUI : TowerGUIImp
	{
        ...
        public SeedTower_7StackGUI()
            : base(typeof(SeedTower_7Stack))	
		{
        ...
        {
            return "Each 10 seconds, this tower puts a new seed to its stack up to 7. Whenever a minion comes near, all seeds in the stack are thrown, causing Seed Tower Plants to appear on the ground for 5 seconds.";
        }
