...
namespace Assets.Scripts.GUI.Missiles
{
	public class SeedTowerPlantMissileGUI : MissileGUIImpl
	{
		...
		{
			staticMissileObject = (GameObject)Resources.Load("3Ds/Missiles/SeedTowerPlantMissile/MissileObject");            
		}
	}
}
