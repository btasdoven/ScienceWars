...
namespace Assets.Scripts.GUI.Missiles
{
	public class ElectricityMissileGUI : MissileGUIImpl
	{
		...
		{
			staticMissileObject = (GameObject)Resources.Load("3Ds/Missiles/ElectricityMissile/MissileObject");
            staticMissileHitEffectObject = (GameObject)Resources.Load("3Ds/Missiles/ElectricityMissile/MissileHitEffectObject");
		}
