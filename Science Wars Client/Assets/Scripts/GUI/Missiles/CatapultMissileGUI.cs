...
namespace Assets.Scripts.GUI.Missiles
{
	public class CatapultMissileGUI : MissileGUIImpl
	{
		...
		{
			staticMissileObject = (GameObject)Resources.Load("3Ds/Missiles/CatapultMissile/MissileObject");            
		}
    }
}
