...
using Assets.Scripts.Engine.Missiles.Chemistry;
...
namespace Assets.Scripts.GUI.Missiles
{
	public class NitrogenBombMissileGUI : MissileGUIImpl
	{
		...
		{
			staticMissileObject = (GameObject)Resources.Load("3Ds/Missiles/NitrogenBombMissile/MissileObject");            
		}
	}
}
