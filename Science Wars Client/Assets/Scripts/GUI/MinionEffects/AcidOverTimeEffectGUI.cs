...
{
    class AcidOverTimeEffectGUI : IMinionEffectGUI
    {
        ...
        {
            staticSpriteContainer = (GameObject)Resources.Load("3Ds/MinionEffects/AcidOverTimeEffect/acidOverTimeEffectObject");
        }
    }
}
