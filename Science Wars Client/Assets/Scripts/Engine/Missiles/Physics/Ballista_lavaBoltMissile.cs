...
{
	class Ballista_lavaBoltMissile : Missile
	{
		public Ballista_lavaBoltMissile(int instanceId, Tower ownerTower, Minion targetMinion) : base(instanceId,ownerTower, targetMinion)
		{
		}
