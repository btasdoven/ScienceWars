...
using Science_Wars_Server.Messages.IncomingMessages;
...
namespace Science_Wars_Server.GameUtilities
{
    public static class TypeIdGenerator
    {
        ...
        // science node instanceları ScienceNode class'inin icinde.

        private static Dictionary<Type, TowerNode> towerNodeInsts;
        public static Dictionary<Type, MinionNode> minionNodeInsts; // root minionlari bulmak icin public olmasi gerekliydi.

        private static Dictionary<int, Type> targetStrategyTypes;
        private static Dictionary<Type, int> targetStrategyIds;
        ...
        static TypeIdGenerator()
        {
            ...
            targetStrategyTypes = generateIdTypeHashMap<ITargetStrategy>();
            targetStrategyIds = generateTypeIdHashMap(typeof(ITargetStrategy));

            //TypeIdGenerator.createLogFile("LogServer.txt");
        }
        ...
        static public int getMinionTypeCount()
        {
            return minionTypes.Count;
        }
        ...
        static public int getTowerTypeCount()
        {
            return towerTypes.Count;
        }
        ...
        static public int getScienceNodeCount()
        {
            return scienceNodeTypes.Count;
        }

        static public TowerNode getTowerNodeInst(Type type)
        {
            return towerNodeInsts[type];
        }

        static public MinionNode getMinionNodeInst(Type type)
        {
